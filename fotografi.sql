...
(2, 'Paket 2', 0, '6 Hours of Usage', 800000, 'Kostum, 3 Background, 27 Foto, (Original Photo), 15 Foto Edit, 3 Cetak', 'no', '2022-06-14 17:03:43', NULL),
(3, 'Paket 3', 0, '10 Hours of Usage', 1200000, 'Kostum, 5 Background, 40 Foto (Original Photo), 20 Foto Edit, 10 Cetak', 'no', '2022-06-14 17:04:46', NULL),
(4, 'Paket 4', 0, '10 Hours of Usage', 1800000, 'Kostum, 7 Background, 50 Foto (Original Photo), 25 Foto Edit, Cetak Album', 'no', '2022-06-14 17:05:35', NULL),
(5, 'Paket 5', 0, 'Unlimited Shoot', 2500000, 'Kostum, Make up, All Background, 80 Foto (Full HD), 40 Foto Edit, Album Jumbo', 'no', '2022-06-14 17:06:46', NULL),
(6, 'Paket 6', 0, 'Unlimited Shoot', 5000000, 'Kostum, Make up, All Background, 110 Foto (Full HD), 60 Foto Edit, Album Jumbo', 'no', '2022-06-14 17:07:33', NULL);
...
--
ALTER TABLE `packets`
  MODIFY `id_packet` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `packet_images`
--
ALTER TABLE `packet_images`
  MODIFY `id_packet_images` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `transaction_images`
  MODIFY `id_transaction_image` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
