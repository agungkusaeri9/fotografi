...
class Paket extends MY_Controller
{
	...
	public function index()
	{
		...
		$data = [
			'content' => 'components/paket/index',
	...
	{
		$this->form_validation->set_rules('packet_name', 'Nama Paker', 'required');
		$this->form_validation->set_rules('id_kategori', 'Kategori', 'required');
		$this->form_validation->set_rules('packet_duration', 'Durasi', 'required');
		$this->form_validation->set_rules('packet_price', 'Harga', 'required');
		$this->form_validation->set_rules('packet_description', 'Deskripsi', 'required');
