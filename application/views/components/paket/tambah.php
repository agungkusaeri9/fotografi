<div class="row">
	<div class="col">
		<div class="card">
			...
			<div class="card-body">
				<form action="<?= base_url('admin/paket/proses_tambah') ?>" method="post">
					<div class='form-group mb-3'>
						<label for='packet_name' class='mb-2'>Nama Paket</label>
						<input type='text' name='packet_name' class='form-control <?php if (form_error('packet_name')) : ?> is-invalid <?php endif; ?>'>
					...
					<div class='form-group mb-3'>
						...
						<input type='text' name='packet_duration' class='form-control <?php if (form_error('packet_duration')) : ?> is-invalid <?php endif; ?>'>
					...
					<div class='form-group mb-3'>
						...
						<input type='text' name='packet_price' class='form-control <?php if (form_error('packet_price')) : ?> is-invalid <?php endif; ?>'>
					...
					<div class='form-group mb-3'>
						...
						<textarea name='packet_description' class='form-control <?php if (form_error('packet_description')) : ?> is-invalid <?php endif; ?>' id='packet_description' cols='10' rows='3'></textarea>
